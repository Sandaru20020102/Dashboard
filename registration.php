                ...
                <div class="card" style="background-color:rgba(0,0,0,0.4);color:white">
                    ...
                    <div class="card-body">
                        <form action="lib/routes/user/Registration.php/" method="post">
                            ...
                            <div class="form-group mt-3">
                                <input type="submit" name="btnSave" id="btnSave" value="Register" id="userPass"
                                    class="btn btn-outline-info btn-sm">
                                <input type="reset" value="Clear" class="btn btn-outline-danger btn-sm">
                            </div>
                            <center><div class="form-group mt-3">
                            <h6> already have an account? <a href="login.php" style="text-decoration: none;" class="text-info">login now</a></h6>
                            </div></center>
                        </form>
                    </div>
                </div>
