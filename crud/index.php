...
<header style="background-color: aliceblue;">
  ...
  <div class="container">
    ...
    ?>
    <center><a href="add-new.php" class="btn btn-info mb-4" style="width: 200px; height: 40px;">Add New Student</a></center>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a style="text-decoration: none; font-weight: bold;" href="edit.php?id=<?php echo $row["id"] ?>" class="link-dark">Edit</a>
