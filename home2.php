...
<body>
  ...
  <div class="row">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" class="navbar bg-dark border-bottom border-body"
        data-bs-theme="dark">
        <div class="container">
          <a class="navbar-brand fs-2" href="home2.html"><span class="text-info">I O I T</span> Sri Lanka</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fs-6 text-center">
              <li class="nav-item">
                <a class="nav-link text-info" href="home2.php">Home</a>
              </li>
             <li class="nav-item">
                <a class="nav-link" href="lib\views\dashboards\user.php">Subjects</a>
              </li>
              <li class="nav-item">
